...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-auth-api-orpin.vercel.app/api/user/update/${currentUser._id}`, {
        method: 'POST',
        headers: {
  ...
  const handleSignOut = async () =>{
    try{
      await fetch('https://mern-auth-api-orpin.vercel.app/api/auth/signout')
      dispatch(signOut())
    }catch(error){
      console.log(error);
    }
