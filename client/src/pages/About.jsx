...
export default function About() {
  return (
    <div className='px-4 py-12 max-w-2xl mx-auto'>
      <h1 className='font-bold text-slate-700 text-3xl text-center m-4'>About Us.</h1>
      <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Beatae voluptates id dolorem, tempore iure libero ex. Esse fugiat dicta quo provident nulla aperiam aut ut alias quisquam, libero vitae accusantium.
